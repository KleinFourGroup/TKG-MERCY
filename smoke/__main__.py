...
from smoke import (
    ...
    mercy_v4_to_v13_end_to_end, scheduling_save_rollback,
    ...
    order_status_crud, order_status_trucks_entry, schedule_tab_generates,
...
def main() -> int:
    ...
    for name, fn in [("compile_all", compile_all),
                     ...
                     ("mercy_v4_to_v13_end_to_end", mercy_v4_to_v13_end_to_end),
