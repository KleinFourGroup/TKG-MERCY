...
class MainWindow(QWidget):
    def __init__(self, db: Database | None = None):
        ...
        self.ordersTab = OrdersTab(self)
        self.salesTab.addTab(self.ordersTab, "Orders")

        from order_status_tab import OrderStatusTab
        self.orderStatusTab = OrderStatusTab(self)
        self.salesTab.addTab(self.orderStatusTab, "Order Status")
        ...
        from workweek_tab import WorkweekTab
        self.workweekTab = WorkweekTab(self)
        self.schedulingConfigTab.addTab(self.workweekTab, "Shift Workweek")

        from part_press_pref_tab import PartPressPrefTab
        ...
        from part_truck_tab import PartTruckTab
        self.partTruckTab = PartTruckTab(self)
        self.schedulingConfigTab.addTab(self.partTruckTab, "Parts per Truck")
    ...
    def _refreshAllTabs(self, hard: bool = True):
        ...
        self.partTruckTab.refreshTable()
        # Sales domain
